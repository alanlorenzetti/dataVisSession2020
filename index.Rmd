...
1. Go to the Cytoscape [download page](https://cytoscape.org/download.html) and install it.

2. Open Cytoscape program and install the following apps:
  + clusterMaker2  
  `Apps -> App Manager -> Search: clusterMaker2 -> Select listing -> Install`  
  + Color Cast  
  `Apps -> App Manager -> Search: Color Cast -> Select listing -> Install`  
  + yFiles Layout Algorithms  
  `Apps -> App Manager -> Search: yFiles -> Select listing -> Install`  
